...
export class ActorsAutocompleteComponent implements OnInit {
  ...
  actors = [
    ...
    {name: 'Kate Winslet', picture: 'https://m.media-amazon.com/images/M/MV5BODgzMzM2NTE0Ml5BMl5BanBnXkFtZTcwMTcyMTkyOQ@@._V1_UX214_CR0,0,214,317_AL_.jpg'}
  ];
  originalActors: {name: string, picture: string}[] = this.actors;
